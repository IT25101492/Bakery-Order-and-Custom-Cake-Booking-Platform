package com.bakery.Usermanagement.util;
...
public class DBConnection {
    ...
    private static final String DB_URL = "jdbc:mysql://localhost:3306/bakery_db?useSSL=false &allowPublicKeyRetrieval=true & serverTimezone=UTC";
