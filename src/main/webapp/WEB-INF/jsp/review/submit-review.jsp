    ...
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        ...
        <div id="tab-product" class="tab-pane active">
            <div class="form-card">
                ...
                <form id="form-product" action="${pageContext.request.contextPath}/reviews/submit/product"
                    method="post">

                    <div class="form-row">
                        <div class="form-group">
                            <label class="form-label" for="pCustomerName">Your Name</label>
                            <input id="pCustomerName" class="form-control" type="text" name="customerName"
                                placeholder="e.g. Alice Fernando" required />
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="pCustomerEmail">Email Address</label>
                            <input id="pCustomerEmail" class="form-control" type="email" name="customerEmail"
                    ...
                    <div class="form-group">
                        ...
                        <input id="pProductName" class="form-control" type="text" name="productName"
                            placeholder="e.g. Chocolate Fudge Cake" required />
                    </div>

                    <div class="form-group">
                        <label class="form-label">Your Rating</label>
                        <div class="star-rating-input" id="star-product">
                            <input type="radio" name="rating" id="ps5" value="5" /><label for="ps5"
                                title="Excellent">★</label>
                            <input type="radio" name="rating" id="ps4" value="4" /><label for="ps4"
                                title="Very Good">★</label>
                            <input type="radio" name="rating" id="ps3" value="3" /><label for="ps3"
                                title="Good">★</label>
                            <input type="radio" name="rating" id="ps2" value="2" /><label for="ps2"
                                title="Fair">★</label>
                            <input type="radio" name="rating" id="ps1" value="1" /><label for="ps1"
                                title="Poor">★</label>
                        </div>
        ...
        <div id="tab-service" class="tab-pane">
            <div class="form-card">
                ...
                <form id="form-service" action="${pageContext.request.contextPath}/reviews/submit/service"
                    method="post">

                    <div class="form-row">
                        <div class="form-group">
                            <label class="form-label" for="sCustomerName">Your Name</label>
                            <input id="sCustomerName" class="form-control" type="text" name="customerName"
                                placeholder="e.g. Kasun Bandara" required />
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="sCustomerEmail">Email Address</label>
                            <input id="sCustomerEmail" class="form-control" type="email" name="customerEmail"
                                placeholder="you@example.com" required />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="star-rating-input" id="star-service">
                            <input type="radio" name="rating" id="ss5" value="5" /><label for="ss5"
                                title="Excellent">★</label>
                            <input type="radio" name="rating" id="ss4" value="4" /><label for="ss4"
                                title="Very Good">★</label>
                            <input type="radio" name="rating" id="ss3" value="3" /><label for="ss3"
                                title="Good">★</label>
                            <input type="radio" name="rating" id="ss2" value="2" /><label for="ss2"
                                title="Fair">★</label>
                            <input type="radio" name="rating" id="ss1" value="1" /><label for="ss1"
                                title="Poor">★</label>
                        </div>
                        <p class="rating-hint">Click a star to rate</p>
                    </div>
